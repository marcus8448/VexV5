...
public:
  std::streambuf *outputBuf = nullptr; // do not delete these in the destructor,
                                       // as they are shared between plugins
  ...
  /**
   * Optionally handle I/O for this type of input. Be sure to read only and all
   * of what you need, otherwise everything will be unaligned.
   */
